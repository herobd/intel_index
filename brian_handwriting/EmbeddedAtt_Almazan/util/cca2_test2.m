...
dlmwrite('i_Cxx_test2.csv',Cxx,'precision',8);
Cyy = Y'*Y/N + reg*eye(Dy);
dlmwrite('i_Cyy_test2.csv',Cyy,'precision',8);
Cxy = X'*Y / N;
dlmwrite('i_Cxy_test2.csv',Cxy,'precision',8);
Cyx = Cxy';
...
M =  ((Cxx\Cxy)/Cyy)*Cyx;
dlmwrite('i_M_test2.csv',M,'precision',8);
