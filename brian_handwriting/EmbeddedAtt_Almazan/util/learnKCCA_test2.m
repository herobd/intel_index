function  [embedding,mAP] = learnKCCA_test2(opts,DATA)
% Evaluate KCCA.
...
dlmwrite('embedding_rndmatx_test2.csv',rndmatx,'precision',8);
dlmwrite('embedding_rndmaty_test2.csv',rndmaty,'precision',8);
dlmwrite('embedding_M_test2.csv',bestM,'precision',8);
dlmwrite('embedding_matt_test2.csv',ma,'precision',8);
dlmwrite('embedding_mphoc_test2.csv',mh,'precision',8);
dlmwrite('embedding_Wx_test2.csv',Wx,'precision',8);
dlmwrite('embedding_Wy_test2.csv',Wy,'precision',8);
