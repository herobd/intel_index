...
VL_EXPORT void
vl_matlab_smooth_f(const float* in, int height, int width, double sigma, float* out, int* outH, int* outW);

VL_EXPORT void
vl_matlab_smooth_d(const double* in, int height, int width, double sigma, double* out, int* outH, int* outW);
