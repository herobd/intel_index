...
\IEEEauthorblockA{Department of Computer Science, Brigham Young University, Provo, Utah\\
...
%The 50\% recall rate used in the previous section was drawn from these results; it will roughly correspond to 66\% precision. This is an acceptable level as users will be discarding less than half of the bigram spotting results.
